...
public final class DeleteImageTask extends DialogTask<Image, List<BaseDescriptionObject>> {
    private long folderId;

    public DeleteImageTask(Activity activity, boolean notifications, long folderId) {
        super(activity, R.string.task_images_delete_title, R.string.task_images_delete_title, notifications);
